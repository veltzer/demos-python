...
def demo():
	...
	file=fselect_demo(d)
	tailbox_demo(d, file)
	d.scrollbox("Now, you're done. No, I'm not kidding. So, why the hell are you sitting here instead of rushing on that EXIT button? Ah, you did like the demo. Hmm... are you feeling OK? ;-)", width=75)
