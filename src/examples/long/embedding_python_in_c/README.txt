...
Notes:
- if you do not want to hardcode paths in your build system to where the python include files and libraries are then you can use the python2.X-config utility supplied with python to give you the information that you need. You should really use it if you want your build system to work accross different types of the linux which have different versions of python and store its files in different folders.
