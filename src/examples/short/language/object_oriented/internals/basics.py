"""
This example demonstrates that an object is just a dictionary and you can access its
underlying dictionary via the __dict__ attribute and see all of its attributes there.
