...
using_re.name = "using_re"  # type: ignore
...
using_translate.name = "using_translate"  # type: ignore
...
results = [(timeit.timeit(f, number=number), f.name) for f in functions]  # type: ignore
